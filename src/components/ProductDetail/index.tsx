...
import { ProductsContainer, ProductImage, ProductName, ProductDescription, ProductPrice, ProductBuy } from "./styles";
    ...
    return (product &&
        <>
            <ProductsContainer>
                ...
                <ProductBuy><CartButton onClick={() => dispatchCart({ type: "add", item: product })}>adicionar ao carrinho</CartButton>
                    <FavoriteButton isFavorite={product.favorite} fill="black" itemId={product.id} />
                </ProductBuy>
            </ProductsContainer >
